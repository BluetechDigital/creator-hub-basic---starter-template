...
import Breadcrumbs from "@/app/videos/[slug]/fragments/Breadcrumbs";
import VideoHero from "@/app/videos/[slug]/fragments/VideoHero";
import LatestVideos from "@/app/videos/[slug]/fragments/LatestVideos";
 ...
 * @param params - Route params promise; resolves to `{slug}`.
...
export const generateMetadata = async ({ params }: { params: { slug: string } }): Promise<Metadata> => {
	...
	return {
		...
		alternates: {
			canonical: `${SITE_URL}/videos/${buildVideoSlug(video.snippet.title, video.videoId)}`,
		},
